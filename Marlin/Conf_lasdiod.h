#ifndef CONF_LASDIOD_H
#define CONF_LASDIOD_H

// @section info

#define MACHINE_NAME "Laser"
#define HAKANS_LASER
// Dual Y: Y2 på E1
// Endstop Y2 på Y2_MIN_PIN=18 = Z_MIN_PIN
// och Y2_MAX_PIN=19 = Z_MAX_PIN
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200,200,4000,500}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {12000, 12000, 5, 25}    // (mm/sec)
